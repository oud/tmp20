...
export const sampleWithRequiredData: IPmEntreprise = {
  ...
  dateCreationJuridique: dayjs('2025-07-01'),
  dateEtat: dayjs('2025-06-30'),
  dateFermetureJuridique: dayjs('2025-07-01'),
  codeTrancheEffectif: 'gadzooks although muscat',
  libelleTrancheEffectif: 'trash plain',
  dateCessationActivite: dayjs('2025-07-01'),
  dateEffectifOfficiel: dayjs('2025-06-30'),
...
export const sampleWithPartialData: IPmEntreprise = {
  ...
  dateCreationJuridique: dayjs('2025-07-01'),
  dateEtat: dayjs('2025-07-01'),
  dateFermetureJuridique: dayjs('2025-06-30'),
  codeTrancheEffectif: 'shameless',
  libelleTrancheEffectif: 'maestro although',
  dateCessationActivite: dayjs('2025-06-30'),
  dateEffectifOfficiel: dayjs('2025-07-01'),
